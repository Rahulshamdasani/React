...
export default function Home() {
  async function hello() { return await fetch(`https://api.hatchways.io/assessment/students`) };
        ...
        <div className='row'>
            ...
            <form>
              <div className="form-group">
                ...
                <input type="text" className="form-control" style={{border:'None', borderBottom:'1px solid'}} id="Search Field" placeholder="Search by name" />
